...
function PCIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="PC" xmlns="http://www.w3.org/2000/svg">
...
function PlayStationIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="PlayStation" xmlns="http://www.w3.org/2000/svg">
...
function XboxIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="Xbox" xmlns="http://www.w3.org/2000/svg">
...
function NintendoIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="Nintendo" xmlns="http://www.w3.org/2000/svg">
...
function MobileIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="Mobile" xmlns="http://www.w3.org/2000/svg">
...
function LinuxIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-zinc-400" title="Linux" xmlns="http://www.w3.org/2000/svg">
...
const PLATFORM_MAP: { key: string; icon: () => JSX.Element }[] = [
  { key: "pc", icon: PCIcon },
